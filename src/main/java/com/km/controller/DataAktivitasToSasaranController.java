...
@RestController
public class DataAktivitasToSasaranController {
	@Autowired
	DataAktivitasToSasaranService service;
	
	public static final Logger Logger = LoggerFactory.getLogger(CheckConnectionController.class);
	
	
	@RequestMapping(value = "/dataAktivitasToSasaran", method = RequestMethod.POST)
	    public ResponseEntity<Map<String, Object>> dataAktivitasToSasaran(@RequestBody Map<String, Object> parameter) {
		 List<?> response = new ArrayList<>();
		 Map<String, Object> result = new HashMap<String, Object>();
		 try {
			  response = service.dataAktivitasToSasaran(parameter);
		...
		public Map<String, Object> resultServiceTrue(List<?> resultService){
			 Map<String, Object> result = new HashMap<String, Object>();
